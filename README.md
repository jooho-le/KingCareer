...
[서비스 열기](https://kingcareer.vercel.app) · [학생 앱](https://kingcareer.vercel.app/app/) · [Vercel Hobby · Supabase 배포 설정](docs/vercel-supabase.md). 로컬은 SQLite, 배포는 Supabase PostgreSQL을 사용합니다.
...
| 미니 프로젝트 | 다섯 직업의 손그림 흐름도에 연결·메모를 더하고 제출. 도안·완성 예시·포트폴리오에 같은 표현을 사용하며 서버 초안·수정 이력 저장 |
...
| 직무별 설계 작업실 | Excalidraw 손글씨·네모·가지선·메모 편집, 도형·글·화살표 연결 유지, 수정본 복원·실제 그림 내보내기 |
...
메뉴·홈 간소화, 모바일 체험 순서, 그림 속 가이드와 빈칸 편집, 최초 방문 도움말은 [학생 사용 흐름 개선](docs/student-usability.md)에 정리했습니다.
